========================================================================
    KONSOLENANWENDUNG: throwback-text-adventure-Projektübersicht
========================================================================

Diese throwback-text-adventure-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre throwback-text-adventure-Anwendung besteht.


throwback-text-adventure.vcxproj
...
throwback-text-adventure.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen throwback-text-adventure.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
